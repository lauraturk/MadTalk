    ...
    return (
      <section className="App">
        <section className="text-source-container">
          ...
          <button className="App-speechBtn" onClick={() => this.setState({speechEnabled: !this.state.speechEnabled})}>{!this.state.speechEnabled ? icons.speakerOff : icons.speakerOn }</button>
